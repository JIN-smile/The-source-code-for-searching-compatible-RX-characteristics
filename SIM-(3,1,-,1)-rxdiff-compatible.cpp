...
void declare(int r)
{
    ...
    for(int i=1; i<=r; i++)
    {
        ...
        cout << "(declare-fun kd1_" << i << " () (_ BitVec 16)) " <<endl;
        ...
        cout << "(declare-fun kvaribits1_" << i << " () (_ BitVec 16)) " <<endl;
        cout << "(declare-fun kdoublebits1_" << i << " () (_ BitVec 16)) " <<endl;
        cout << "(declare-fun kz1_" << i << " () (_ BitVec 16)) " <<endl;
...
void cczformula_delta(int r)
{
    ...
    cout<< " (assert (= kvaribits1_1  (bvor  ((_ rotate_left 1) dk0)  dk0)))"<<endl;

    cout<< " (assert (= kdoublebits1_1  (bvand  (bvand (bvxor ((_ rotate_left 1) dk0) #xffff)  dk0) ((_ rotate_left 2) dk0))))"<<endl;

    cout<< " (assert (= #x0000 (bvand  (bvxor kvaribits1_1 #xffff)  kd1_1))) "<<endl;

    cout<< " (assert (= #x0000 (bvand  (bvxor ((_ rotate_left 1) kd1_1) kd1_1) kdoublebits1_1))) "<<endl;


    cout<< " (assert (= klft_1  (bvxor (bvxor dk kd_1 ) (bvxor (bvxor kd1_1 ((_ rotate_left 1) c_1))  c_1))))"<<endl;

    cout<< " (assert (= kz_1 (bvxor kvaribits_1 kdoublebits_1)))"<<endl;

    cout<< " (assert (= kz1_1 (bvxor kvaribits1_1 kdoublebits1_1)))"<<endl;
    ...
    cout<< " (assert (= kvaribits1_2  (bvor  ((_ rotate_left 1) dk1)  dk1)))"<<endl;

    cout<< " (assert (= kdoublebits1_2  (bvand  (bvand (bvxor ((_ rotate_left 1) dk1) #xffff)  dk1) ((_ rotate_left 2) dk1))))"<<endl;

    cout<< " (assert (= #x0000 (bvand  (bvxor kvaribits1_2 #xffff)  kd1_2))) "<<endl;

    cout<< " (assert (= #x0000 (bvand  (bvxor ((_ rotate_left 1) kd1_2) kd1_2) kdoublebits1_2))) "<<endl;


    cout<< " (assert (= klft_2  (bvxor (bvxor krgt_1 kd_2 ) (bvxor (bvxor kd1_2 ((_ rotate_left 1) c_2))  c_2)) ))"<<endl;

    cout<< " (assert (= kz_2 (bvxor kvaribits_2 kdoublebits_2)))"<<endl;

    cout<< " (assert (= kz1_2 (bvxor kvaribits1_2 kdoublebits1_2)))"<<endl;
    ...
    cout<< " (assert (= kvaribits1_3  (bvor  ((_ rotate_left 1) dk2)  dk2)))"<<endl;

    cout<< " (assert (= kdoublebits1_3  (bvand  (bvand (bvxor ((_ rotate_left 1) dk2) #xffff)  dk2) ((_ rotate_left 2) dk2))))"<<endl;

    cout<< " (assert (= #x0000 (bvand  (bvxor kvaribits1_3 #xffff)  kd1_3))) "<<endl;

    cout<< " (assert (= #x0000 (bvand  (bvxor ((_ rotate_left 1) kd1_3) kd1_3) kdoublebits1_3))) "<<endl;



    cout<< " (assert (= klft_3  (bvxor (bvxor krgt_2 kd_3 ) (bvxor (bvxor kd1_3 ((_ rotate_left 1) c_3))  c_3)) ))"<<endl;

    cout<< " (assert (= kz_3 (bvxor kvaribits_3 kdoublebits_3)))"<<endl;

    cout<< " (assert (= kz1_3 (bvxor kvaribits1_3 kdoublebits1_3)))"<<endl;
    ...
    for(int i=1; i<=(r-3);i++)
    {
        ...
        cout<< " (assert (= kvaribits1_"<<i+3<<"  (bvor  ((_ rotate_left 1) klft_"<< i<<")  klft_"<< i<<")))"<<endl;

        cout<< " (assert (= kdoublebits1_"<<i+3<<"  (bvand  (bvand (bvxor ((_ rotate_left 1) klft_"<< i<<") #xffff)  klft_"<< i<<") ((_ rotate_left 2) klft_"<< i<<"))))"<<endl;

        cout<< " (assert (= #x0000 (bvand  (bvxor kvaribits1_"<<i+3<<" #xffff)  kd1_"<<i+3<<"))) "<<endl;

        cout<< " (assert (= #x0000 (bvand  (bvxor ((_ rotate_left 1) kd1_"<<i+3<<") kd1_"<<i+3<<") kdoublebits1_"<<i+3<<"))) "<<endl;

        cout<< " (assert (= klft_"<< i+3 <<"  (bvxor (bvxor krgt_"<<i+2<<" kd_"<<i+3<<" ) (bvxor (bvxor kd1_"<<i+3<<" ((_ rotate_left 1) c_"<<i+3<<"))  c_"<<i+3<<")) ))"<<endl;

        cout<< " (assert (= kz_"<< i+3 <<" (bvxor kvaribits_"<<i+3<<" kdoublebits_"<<i+3<<")))"<<endl;

        cout<< " (assert (= kz1_"<< i+3 <<" (bvxor kvaribits1_"<<i+3<<" kdoublebits1_"<<i+3<<")))"<<endl;
...
void cczformula_value(int r)
{
    ...
    for(int i=1; i<=(r-4);i++)
    {
        ...
        cout<< " (assert (= value_k_"<< i+4 <<"  (bvxor (bvxor (bvxor (bvand ((_ rotate_left 5) value_k_"<< i+1 <<") value_k_"<< i+1 <<") (bvand ((_ rotate_left 1) value_k_"<< i+1 <<") value_k_"<< i+1 <<")) c_"<<i<<") value_k_"<< i <<")))"<<endl;
    ...
    for(int i=1; i<=(r-4);i++)
    {
        ...
        cout<< " (assert (= value_kpie_"<< i+4 <<"  (bvxor (bvxor (bvxor (bvand ((_ rotate_left 5) value_kpie_"<< i+1 <<") value_kpie_"<< i+1 <<") (bvand ((_ rotate_left 1) value_kpie_"<< i+1 <<") value_kpie_"<< i+1 <<")) c_"<<i<<") value_kpie_"<< i <<")))"<<endl;
...
void objectivefun(int r, int bound_key,int bound_plain)
{
    ...
    for(int i=1; i<=r;i++)
    {
        cout<< " (assert (= kwr_"<<i<<" (bvadd (w_H kz_"<<i<<") (w_H kz1_"<<i<<"))))"<<endl;
    }
...
void tail(int r)
{
	...
	for(int i=1;i<=r;i++)
	{
	    ...
	    cout << "(get-value (kd1_"<< i <<"))" << endl;
	    cout << "(get-value (c_"<< i <<"))" << endl;
	    cout << "(get-value (kz_"<< i <<"))" << endl;
	    cout << "(get-value (kz1_"<< i <<"))" << endl;
