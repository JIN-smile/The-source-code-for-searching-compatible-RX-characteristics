...
void cczformula_delta(int r)
{
    ...
    cout<< " (assert (= klft_1  (bvxor (bvxor dk kd_1 ) (bvxor ((_ rotate_left 1) c_1)  c_1)) ))"<<endl;
    ...
    cout<< " (assert (= klft_2  (bvxor (bvxor krgt_1 kd_2 ) (bvxor ((_ rotate_left 1) c_2)  c_2)) ))"<<endl;
    ...
    cout<< " (assert (= klft_3  (bvxor (bvxor krgt_2 kd_3 ) (bvxor  ((_ rotate_left 1) c_3)  c_3)) ))"<<endl;
    ...
    for(int i=1; i<=(r-3);i++)
    {
        ...
        cout<< " (assert (= klft_"<< i+3 <<"  (bvxor (bvxor krgt_"<<i+2<<" kd_"<<i+3<<" ) (bvxor  ((_ rotate_left 1) c_"<<i+3<<")  c_"<<i+3<<")) ))"<<endl;
...
void cczformula_value(int r)
{
    ...
    for(int i=1; i<=(r-4);i++)
    {
        ...
        cout<< " (assert (= value_k_"<< i+4 <<"  (bvxor (bvxor (bvand ((_ rotate_left 5) value_k_"<< i+1 <<") value_k_"<< i+1 <<") c_"<<i<<") value_k_"<< i <<")))"<<endl;
    ...
    for(int i=1; i<=(r-4);i++)
    {
        ...
        cout<< " (assert (= value_kpie_"<< i+4 <<"  (bvxor (bvxor (bvand ((_ rotate_left 5) value_kpie_"<< i+1 <<") value_kpie_"<< i+1 <<") c_"<<i<<") value_kpie_"<< i <<")))"<<endl;
