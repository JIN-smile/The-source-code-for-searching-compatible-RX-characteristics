...
void cczformula_delta(int r)
{
    ...
    cout<< " (assert (= kvaribits_1  (bvor  ((_ rotate_left 8) dk0) ((_ rotate_left 1) dk0))))"<<endl;

    cout<< " (assert (= kdoublebits_1  (bvand  (bvand (bvxor ((_ rotate_left 8) dk0) #xffff)  ((_ rotate_left 1) dk0)) ((_ rotate_left 15) dk0))))"<<endl;
    ...
    cout<< " (assert (= klft_1  (bvxor (bvxor dk kd_1 ) (bvxor (bvxor ((_ rotate_left 2) dk0) ((_ rotate_left 1) c_1))  c_1)) ))"<<endl;
    ...
    cout<< " (assert (= kvaribits_2  (bvor  ((_ rotate_left 8) dk1)  ((_ rotate_left 1) dk1))))"<<endl;

    cout<< " (assert (= kdoublebits_2  (bvand  (bvand (bvxor ((_ rotate_left 8) dk1) #xffff) ((_ rotate_left 1) dk1)) ((_ rotate_left 15) dk1))))"<<endl;
    ...
    cout<< " (assert (= klft_2  (bvxor (bvxor krgt_1 kd_2 ) (bvxor (bvxor ((_ rotate_left 2) dk1) ((_ rotate_left 1) c_2))  c_2)) ))"<<endl;
    ...
    cout<< " (assert (= kvaribits_3  (bvor  ((_ rotate_left 8) dk2) ((_ rotate_left 1) dk2))))"<<endl;

    cout<< " (assert (= kdoublebits_3  (bvand  (bvand (bvxor ((_ rotate_left 8) dk2) #xffff)  ((_ rotate_left 1) dk2)) ((_ rotate_left 15) dk2))))"<<endl;
    ...
    cout<< " (assert (= klft_3  (bvxor (bvxor krgt_2 kd_3 ) (bvxor (bvxor ((_ rotate_left 2) dk2) ((_ rotate_left 1) c_3))  c_3)) ))"<<endl;
    ...
    for(int i=1; i<=(r-3);i++)
    {
        ...
        cout<< " (assert (= kvaribits_"<<i+3<<"  (bvor  ((_ rotate_left 8) klft_"<< i<<") ((_ rotate_left 1) klft_"<< i<<"))))"<<endl;

        cout<< " (assert (= kdoublebits_"<<i+3<<"  (bvand  (bvand (bvxor ((_ rotate_left 8) klft_"<< i<<") #xffff) ((_ rotate_left 1) klft_"<< i<<")) ((_ rotate_left 15) klft_"<< i<<"))))"<<endl;
        ...
        cout<< " (assert (= klft_"<< i+3 <<"  (bvxor (bvxor krgt_"<<i+2<<" kd_"<<i+3<<" ) (bvxor (bvxor ((_ rotate_left 2) klft_"<<i<<") ((_ rotate_left 1) c_"<<i+3<<"))  c_"<<i+3<<")) ))"<<endl;
...
void cczformula_value(int r)
{
    ...
    for(int i=1; i<=(r-4);i++)
    {
        ...
        cout<< " (assert (= value_k_"<< i+4 <<"  (bvxor (bvxor (bvxor (bvand ((_ rotate_left 8) value_k_"<< i+1 <<") ((_ rotate_left 1)value_k_"<< i+1 <<")) ((_ rotate_left 2) value_k_"<< i+1 <<")) c_"<<i<<") value_k_"<< i <<")))"<<endl;
    ...
    for(int i=1; i<=(r-4);i++)
    {
        ...
        cout<< " (assert (= value_kpie_"<< i+4 <<"  (bvxor (bvxor (bvxor (bvand ((_ rotate_left 8) value_kpie_"<< i+1 <<") ((_ rotate_left 1) value_kpie_"<< i+1 <<")) ((_ rotate_left 2) value_kpie_"<< i+1 <<")) c_"<<i<<") value_kpie_"<< i <<")))"<<endl;
