...
void cczformula_delta(int r)
{
    ...
    for(int i=1; i<=(r-4);i++)
    {
        ...
        cout<< " (assert (= k_"<< i+4 <<"  (bvxor ((_ rotate_left 1) c_"<< i<<") (bvxor (bvxor (bvxor ((_ rotate_left 5) k_"<< i+1<<") ((_ rotate_left 1) k_"<< i+1<<")) (bvxor k_"<< i<<"  c_"<< i<<")) k_"<< i+1<<"))))"<<endl;
...
void cczformula_value(int r)
{
    ...
    for(int i=1; i<=(r-4);i++)
    {
        ...
        cout<< " (assert (= value_k_"<< i+4 <<"  (bvxor (bvxor (bvxor ((_ rotate_left 5) value_k_"<< i+1<<") ((_ rotate_left 1) value_k_"<< i+1<<")) (bvxor value_k_"<< i<<"  c_"<< i<<")) value_k_"<< i+1<<")))"<<endl;
    ...
    for(int i=1; i<=(r-4);i++)
    {
        ...
        cout<< " (assert (= value_kpie_"<< i+4 <<"  (bvxor (bvxor (bvxor ((_ rotate_left 5) value_kpie_"<< i+1<<") ((_ rotate_left 1) value_kpie_"<< i+1<<")) (bvxor value_kpie_"<< i<<"  c_"<< i<<")) value_kpie_"<< i+1<<")))"<<endl;
